  ...
  namespace :extensions do
    namespace :newsletter do
      ...
      task :update => :environment do
        ...
        puts "Copying assets from NewsletterExtension"
        ...
        unless NewsletterExtension.root.starts_with? RAILS_ROOT # don't need to copy vendored tasks
          puts "Copying rake tasks from NewsletterExtension"
          local_tasks_path = File.join(RAILS_ROOT, %w(lib tasks))
          mkdir_p local_tasks_path, :verbose => false
          Dir[File.join NewsletterExtension.root, %w(lib tasks *.rake)].each do |file|
      ...
      task :sync => :environment do
        ...
        language_root = NewsletterExtension.root + "/config/locales"
